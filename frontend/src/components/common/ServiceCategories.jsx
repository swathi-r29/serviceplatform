...
const ServiceCategories = () => {
  ...
  const categoryConfig = {
    ...
    'Moving & Packing': { icon: '🚛', color: 'bg-amber-50', iconBg: 'bg-amber-100' },
    'Home Tutoring': { icon: '📚', color: 'bg-sky-50', iconBg: 'bg-sky-100' },
    'Salon & Spa': { icon: '💅', color: 'bg-fuchsia-50', iconBg: 'bg-fuchsia-100' },
